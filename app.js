...
const PHASE_THREE_CONFIG = {
  ...
  letterParagraphs: [
    "Mer, esta carta estaba escondida detras de cada prueba porque queria que llegar hasta aqui se sintiera como una pequena aventura.",
    "Me encanta compartir contigo estos momentos tontos, bonitos y un poco misteriosos. Me haces sonreir de una forma que no cabe en ningun codigo secreto.",
    "Asi que aqui va la ultima pista, la mas facil y la mas importante: quiero seguir creando recuerdos contigo.",
  ],
